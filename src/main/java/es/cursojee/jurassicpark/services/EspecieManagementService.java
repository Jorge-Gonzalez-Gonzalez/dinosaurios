...
public interface EspecieManagementService {
	...
	ResponseEspecieDto findById(Long id) throws DinosaurioElementNotFoundException;
	...
	void delete(RequestDeleteEspecieDto requestDeleteEspecieDto) throws DinosaurioElementNotFoundException, NotConfirmDeleteDinosaurio, IntegratedForeignKeyException;
